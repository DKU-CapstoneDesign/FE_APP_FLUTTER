...
import 'package:capstonedesign/view/widgets/cards/postListView.dart';
...
class _MyPageState extends State<MyPage> {
  ...
  Future<bool> logout() async {
    final url = Uri.parse('https://true-porpoise-uniformly.ngrok-free.app/api/logout');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData.containsKey('loggedOut') &&
          ...
          // Logout failed or response format unexpected
          return false;
        }
      } else {
        // HTTP request failed
